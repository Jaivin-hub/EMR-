                                    ...
                                    <div className="col-md-10">
                                        ...
                                        <div className="row ">
                                            ...
                                            <div className="timeScedulediv mt-4" style={{ width: '90%', marginLeft: "5%", height: '4em', borderRadius: '5px', border: '1px ', backgroundColor: 'rgba(0, 0, 0, 0.03)' }}>
                                                <div className="row mt-3">
                                                    <div className="col-md-3 " >
                                                        <input id='doc_avail_day' onChange={(e) => { handleTimeSchedule(e) }} type="text" style={{ width: "90%", position: 'relative', border: '1px solid #EEEEEE' }} placeholder="Date" />
                                        ...
                                        /> */}
                                                    ...
                                                    <div className="col-md-3">
                                                        <input id="doc_from_time" onChange={(e) => { handleTimeSchedule(e) }} type="text" style={{ width: "90%", position: 'relative', border: '1px solid #EEEEEE' }} placeholder="Time From" />
                                                        <AiOutlineClockCircle />

                                                    </div>
                                                    <div className="col-md-3">
                                                        <input id="doc_to_time" onChange={(e) => { handleTimeSchedule(e) }} type="text" style={{ width: "90%", position: 'relative', border: '1px solid #EEEEEE' }} placeholder="Time To" />
                                                        <AiOutlineClockCircle />
                                                    </div>
                                                    <div className="col-md-3">
                                                        <div className="row">
